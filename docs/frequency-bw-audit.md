...
- V prehliadači overené názvy BW, oddelené desatinné hodnoty, nula, odmietnutie záporného vstupu, prijatie prázdneho BW ako nuly a odoslanie spoločného zoznamu automatických a manuálnych filtrov, odstránenie duplicít a vypnutie filtrov. Wails most bol pri kontrole UI simulovaný; výpočty nad reálnymi súbormi bežali v Go backende.
